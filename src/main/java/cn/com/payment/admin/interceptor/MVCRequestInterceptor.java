 ...
 * @version 1.0
 */
public class MVCRequestInterceptor extends ExecutionApiLogMethodInterceptor implements HandlerInterceptor {
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        try {
            info("执行业务逻辑代码耗时：【{}ms】", new Date().getTime() - startTimeThreadLocal.get());
            String requestURL = request.getRequestURI();
            info("当前请求的URL：【{}】", requestURL);
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        ...
        try {
            ...
            info("MVC返回请求完成耗时：【{}ms】", new Date().getTime() - startTimeThreadLocal.get());
            if (ex != null) {
