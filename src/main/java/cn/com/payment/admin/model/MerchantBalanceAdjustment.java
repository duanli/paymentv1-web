...
public class MerchantBalanceAdjustment implements Serializable {
	...
	public MerchantBalanceAdjustment(Long adjustId, Long ralAccProductId, Long operatorId, String adjustType,
			Long beforBalance, Long afterBalance, Long adjustAmount, String state, Date createTime, Date updateTime) {
