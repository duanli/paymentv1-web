...
public class RalProviderTransModeController {
	...
	@RequiresPermissions("ralProviderTransMode:view")
	public @ResponseBody PageEasyUi<RalProviderTransMode> getRalProviderTransModePage(
			PageEasyUi<RalProviderTransMode> page, RalProviderTransMode entity) {
	 ...
	 * @return
	 */
	@RequestMapping("getRalProviderTransModeList")
	@RequiresPermissions("ralProviderTransMode:view")
	public @ResponseBody List<RalProviderTransMode> getRalProviderTransModeList(PageEasyUi<RalProviderTransMode> page,
			RalProviderTransMode entity) {
		List<RalProviderTransMode> result = null;
		try {
			PageUtils.initPages(page.getPageNumber(), page.getPageSize());
			result = this.ralProviderTransModeService.searchByProperty(entity);
		} catch (Exception e) {
			logger.error(e.getMessage(), e);
		}
		return result;
	...
	public @ResponseBody ResponseEntity<String> updateRalProviderTransMode(RalProviderTransMode ralProviderTransMode,
		...
		try {
			...
			if (CommonUtils.isNotEmpty(data)) {
				...
				if (CommonUtils.isNotEmpty(ralProviderTransMode.getSettleType()))
					data.setSettleType(ralProviderTransMode.getSettleType());
