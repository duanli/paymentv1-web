package cn.com.payment.admin.config;
...
import cn.com.payment.admin.controller.context.CustomerUserRealm;
...
//	}
	...
	private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean) {
		...
		filterChainDefinitionMap.put("/images/**", "anon");// anon
		filterChainDefinitionMap.put("/css/**", "anon");// anon
		filterChainDefinitionMap.put("/js/**", "anon");// anon
		filterChainDefinitionMap.put("/pages/**", "anon");// anon
		filterChainDefinitionMap.put("/druid/**", "anon");// anon
		filterChainDefinitionMap.put("/download/**", "anon");// anon
		filterChainDefinitionMap.put("/request/uploadImg", "anon");// anon
		filterChainDefinitionMap.put("/uploadfiles", "anon");// anon
		filterChainDefinitionMap.put("/kindeditor", "anon");// anon
